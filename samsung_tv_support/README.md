...
I currently don't have a Samsung TV, so can't test this, but I did find several scripts that should be relatively easy to convert to control a Samsung TV as well.
